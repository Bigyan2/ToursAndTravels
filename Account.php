    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <div class="card">
                    ...
                    <form method="POST" action="">
                        <label for="old_password">Old Password:</label><input type="text" placeholder="Old Password " id="name" name="old_password" required><br><br>
                        
                        <label for="new_password">New Password:</label>
                        <input type="text" id="email" placeholder="New Password " name="new_password" required><br><br>
...
<div class="Dassh">
    ...
    <ul>
      ...
      <ul>
        <li><a href="Backend/logout.php"><img src="Account/logout.png">Logout</a> </li>
      </ul>
</div>   
